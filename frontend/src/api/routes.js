...
try {
  userRoutes = require("./users"); // Updated to match routes structure
...
try {
  shiftRoutes = require("./shifts"); // Updated to match routes structure
...
try {
  invoiceRoutes = require("./invoices"); // Updated to match routes structure
